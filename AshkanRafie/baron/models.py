...
class TestResult(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE,related_name="baron_test_results")
    date_taken = models.DateTimeField(auto_now_add=True)
    results = models.JSONField()  # برای ذخیره نمرات ابعاد مختلف، به عنوان مثال، {'INT': 15, 'EMC': 20, ...}
