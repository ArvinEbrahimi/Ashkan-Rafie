"""
Django settings for AshkanRafie project.
...
SECRET_KEY = 'django-insecure-)=uh$&d5&-tc%v-b+fwgbp!c70%izyh&_f)v=8&n1&2lfe=2w5'
...
WSGI_APPLICATION = 'AshkanRafie.wsgi.application'
